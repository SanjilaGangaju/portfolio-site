...
const About = ({darkMode}) => {
  return (
    <div className={`p-10 flex flex-col gap-5 ${darkMode?"darkmode":"lightmode"}`}>
      <div className=' flex flex-col items-center gap-2 justify-center'>
        <div className='w-full flex items-center gap-4'>
          <h2 className='font-saint  text-4xl font-semibold'>intro</h2>
      ...
      <div className='flex flex-col items-center justify-center'>
         <div className='w-full flex items-center gap-4'>
          <h2 className='font-saint  text-4xl font-semibold'>skills</h2>
          <hr className='w-1/2 border-2 '></hr>
        </div>
       ...
       <div className='flex flex-col items-center justify-center'>
        <div className='w-full flex items-center gap-4'>
          <h2 className='font-saint  text-4xl font-semibold'>experience</h2>
          <hr className='w-1/2  border-2 '></hr>
        </div>
        <div className='flex w-full gap-10 items-center  justify-center '>
          <div className={`flex flex-col p-4 items-center mt-4 ${darkMode?"bg-transparent border rounded": "bg-yellow-100"}`}>
        ...
        <div>
          <button className='border-b border-white border-dashed   font-saint  px-3 hover:border-b hover:text-red-700 hover:border-red-800'><Link to="/projects" className='font-saint text-[1.9rem] hover:text-red-800' >explore my projects~</Link></button>
      ...
      <div className='flex flex-col items-center gap-5'>
        <div className='w-full flex items-center gap-4'>
          <h2 className='font-saint  text-4xl font-semibold'>education</h2>
          <hr className='w-1/2  border-2'></hr>
        </div>
        <div className='relative w-full h-full  flex flex-col  gap-10 border-l-7 border-redwood'>
          
           <div className={`rounded flex items-center ${darkMode?"bg-transparent border border-redwood rounded": "bg-yellow-100"}`}>
           ...
           <div className={` flex items-center ${darkMode?"bg-transparent border border-redwood rounded": "bg-yellow-100"}`}>
            <div className='w-3 h-3 bg-redwood rounded-full absolute -left-[12px]'></div>
            <p className='ml-5 p-2 flex flex-col gap-2'>
