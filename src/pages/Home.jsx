...
const Home = () => {
  return (
    <div className='font-imperial flex flex-col gap-7 text-center items-center p-12'>
      <span  className='text-redwood text-6xl font-[500] text-left' data-aos="zoom-in" data-aos-duration="1500">Hey! It's</span>
      <span className='text-redwood text-7xl ' data-aos="zoom-in" data-aos-duration="1500">Sanjila Gangaju</span>
      <p className='font-sans flex items-center gap-4 text-center font-[700]  mt-2 text-[0.8rem] text-redwood '>
      <span className='w-16'><hr></hr></span>
